...
export default function WhyChoose() {
  ...
  return (
    <section id="why-choose" className="py-12 px-4 md:px-8 bg-[#f5efe4] select-none scroll-mt-20 overflow-hidden">

      {/* Brown Rounded Container */}
      <div className="max-w-7xl mx-auto bg-[#874b35] rounded-[2.5rem] py-16 px-4 md:px-12 relative shadow-2xl overflow-hidden">
